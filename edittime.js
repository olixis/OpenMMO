function GetPluginSettings()
{
	return {
		...
		"rotatable":	 false,
		"dependency":	"socket.io.min.js",					// only used when "type" is "world".  Enables an angle property on the object.
...
// example
AddStringParam("IP Address", "Enter the IP address of the Socket.io server.");
AddNumberParam("Port", "Enter the port of the Socket.io server.");
AddAction(0, af_none, "Connect", "Connection", "Connect to {0}:{1}", "Connects to the desired Socket.io server.", "connect");
AddStringParam("Event Name", "Enter the event name being emmited to the Socket.io server.");
AddStringParam("Data", "Enter the data being sent to the Socket.io server.");
AddAction(1, af_none, "Emit", "Emission", "Works like: socket.emit('{0}',{1}))", "Emmits data to the desired Socket.io server.", "emit");
